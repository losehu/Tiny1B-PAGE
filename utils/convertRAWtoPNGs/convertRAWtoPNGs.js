...
/*
// Range dynamic variation
const a = 2 * Math.PI * numFrame / 120;
const offset = Math.sin( a ) * 700;
//const offset = Math.sin( a ) * 1400;
temperatureRawValue += offset;
temperatureRawValue = Math.max( 0, Math.min( 65535, Math.round( temperatureRawValue ) ) );
*/
